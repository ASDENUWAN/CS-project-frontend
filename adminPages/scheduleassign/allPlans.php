...
<script>
    ...
    //let memberSID = urlParams.get('memberSID');
    ...
    function displayPlans(plans) {
        ...
        plans.forEach(plan => {
            ...
            row.addEventListener("click", function() {
                window.location.href = `adminPanel.php?page=planDetails&&fd=scheduleassign&&wpID=${plan.wpID}`;
            });
    ...
    backBtn.addEventListener('click', () => {
        if (memberSID) {
            window.location.href = 'adminPanel.php?page=editScheduleDetails&&fd=scheduleassign&&memberSID=' + memberSID;
        } else {
            window.location.href = 'adminPanel.php?page=addScheduleDetails&&fd=scheduleassign';
        }
    });
</script>

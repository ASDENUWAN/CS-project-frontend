    ...
    <div class="container mt-5">
        ...
        <div id="planDetails" style="display: none;">
            ...
            <div class="mt-4 d-flex justify-content-center gap-3">
                <button id="editBtn" class="btn btn-warning me-2"><i class="bi bi-pencil-square"></i> Edit Plan</button>
                <button id="deleteBtn" class="btn btn-danger me-2"><i class="bi bi-trash-fill"></i> Delete Plan</button>
                <button id="backBtn" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Back to Plans</button>
            </div>
        </div>
...
<script>
    ...
    editBtn.addEventListener('click', () => {
        window.location.href = `adminPanel.php?page=updatePlan&&fd=schedules&wpID=${wpID}`;
    });
    ...
    deleteBtn.addEventListener('click', async () => {
        ...
        try {
            const deleteResponse = await fetch('http://localhost/Fitness%20Center/backend/Schdule%20management/Plan%20management/removePlan.php', {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (deleteResult.success) {
                ...
                alert(deleteResult.message || 'Failed to delete workout plan.');
            }
        } catch (error) {
            console.error(error);

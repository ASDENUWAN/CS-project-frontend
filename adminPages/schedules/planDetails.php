    ...
    <div class="container mt-5">
        ...
        <div id="planDetails" style="display: none;">
            ...
            <div class="mt-4 d-flex justify-content-center flex-wrap">
                <button id="editBtn" class="btn btn-warning mx-3 my-2">
                    <i class="bi bi-pencil-square"></i> Edit Plan
                </button>
                <button id="deleteBtn" class="btn btn-danger mx-3 my-2">
                    <i class="bi bi-trash-fill"></i> Delete Plan
                </button>
...
<script>
    ...
    deleteBtn.addEventListener('click', async () => {
        ...
        try {
            const deleteResponse = await fetch('http://localhost/cs/backend/exPlanManagement/removePlan.php', {
                method: 'DELETE',
                headers: {
                    'Content-Type': 'application/json'
                },
